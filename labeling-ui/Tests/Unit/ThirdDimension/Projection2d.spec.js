...
describe('Projection2d', () => {
  ...
  beforeEach(() => {
    ...
    projection = new Projection2d(calibrationObject);
  });

  it('should instantiate with camera calibration information', () => {
    expect(projection instanceof Projection2d).toBeTruthy();
  });
  ...
  using([
    ...
    it('should correctly project 3d coordinates into 2d coordinates', () => {
      expect(projection.project3dTo2d(inVector)).toEqual(outVector);
    });
  });
});
