(function(context){
	var expectations = [
		...
		{
			request: {
				path: '/some/:named/param/with/:value',
				namedParams: true,
				method: 'get',
			},
			response: {
				data: 'named params match',
				named: '{{named}}',
				value: '{{value}}'
			}
		},
		{
			...
			response: {
				data: 'named params params match',
				skip: '{{skip}}',
				limit: '{{limit}}',
			}
		},
		...
		{
			request: {
				path: '/named/inline/string/:verb/:times',
				namedParams: true,
				method: 'get',
			},
			response: {
				data: 'I {{verb}} you {{times}} times',
			}
		},
		{
			request: {
				path: '/non/named/params',
				method: 'put',
				data: {
					id: '{{:id}}'
				}
