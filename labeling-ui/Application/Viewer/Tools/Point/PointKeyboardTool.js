...
/**
 * Keyboard shortcuts for point shapes
 *
 * @extends KeyboardTool
 */
class PointKeyboardTool extends KeyboardTool {
  /**
 ...
 * @static
 */
PointKeyboardTool.getToolName = () => {
  return 'PointKeyboardTool';
};
 ...
 * @static
 */
PointKeyboardTool.isShapeClassSupported = shapeClass => {
  return [
    'point',
  ].includes(shapeClass);
};
 ...
 * @static
 */
PointKeyboardTool.isActionIdentifierSupported = actionIdentifier => {
  return [
    'keyboard',
  ].includes(actionIdentifier);
};

PointKeyboardTool.$inject = [
  'drawingContext',
  '$rootScope',
  '$q',
  'loggerService',
...
export default PointKeyboardTool;
