<?php
namespace crosscan\Tests\Logger;

/**
 * This file has been taken from Marcus Börgers MultipleIterator
 * implementation, which is part of the SPL extension of PHP.
 *
 * Unfortunately the implementation of the key method is not conforming to the
 * php restriction, that keys have to be scalar values. Therefore This one bit
 * has been changed.
 */
...
class MultipleIterator implements \Iterator {
    ...
    public function key()
    {
        ...
        // Change due to PHP restricitions about scalar key values.
        // Return always the first iterator key.
        return $retval[0];
    }
}
