...
class UserPermissions
{
    ...
    const PERMISSION_MAP = [
        ...
        'canChangeProjectLabelGroupAssignment'   => [Model\User::ROLE_SUPER_ADMIN, Model\User::ROLE_ADMIN,                                                                                                                                                ],
        'canAssignAllGroupsToProjects'           => [Model\User::ROLE_SUPER_ADMIN, Model\User::ROLE_ADMIN,                                                                                                                                                ],
        ...
        'canAddUserToOwnOrganisation'            => [Model\User::ROLE_SUPER_ADMIN, Model\User::ROLE_ADMIN,                                                                                                                                                ],
