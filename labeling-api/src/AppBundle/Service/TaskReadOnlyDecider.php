...
class TaskReadOnlyDecider
{
    ...
    {
        if ($labelingTask->getAssignedUserId() !== null &&
            ($labelingTask->getStatus() === Model\LabelingTask::STATUS_TODO || $labelingTask->getStatus() === Model\LabelingTask::STATUS_IN_PROGRESS)
        ) {
